// Mismo patron que el panel de administracion (apps/admin/src/lib/sesion.tsx).
// Se mantiene una copia por app para que cada frontend sea desplegable por separado.
