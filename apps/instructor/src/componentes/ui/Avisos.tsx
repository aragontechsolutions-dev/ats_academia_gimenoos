 ...
 * un aviso que aparece ahí tapa justo lo que se estaba mirando.
...
export function Avisos() {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed inset-x-3 bottom-[calc(0.75rem+env(safe-area-inset-bottom))] z-[60] flex flex-col gap-2 sm:inset-x-auto sm:right-4 sm:w-96"
      aria-live="polite"
    >
      {avisos.map((aviso) => (
